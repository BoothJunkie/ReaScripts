--[[
 * @description BJ_Set Selected Track height to XL
 * @version 1.0
 * @author Mike DelGaudio
 * @authorURI http://boothjunkie.com
 * @about
 *    Sets the height of any selected track to 500 pixels.
 *    Useful for quick resizing of track heights for editing and using free item positioning.
 *    Select the track you want to make extra tall and run this action.
...
-- Example usage:
set_selected_tracks_height(500)  -- sets all selected tracks to 'Medium' height
